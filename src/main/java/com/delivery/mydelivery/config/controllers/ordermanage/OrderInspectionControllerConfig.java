...
@Configuration
public class OrderInspectionControllerConfig implements WebMvcConfigurer {
    @Autowired
    private JwtValidationInterceptor jwtValidationInterceptor;

    @Override
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(jwtValidationInterceptor).addPathPatterns("/api/orders-inspection/**");
    }
}
